    ...
    function create(aData){
        ...
        function create3D(obj){
            ...
            /*function replaceImg(){
                ...
                oPicBox1.style.left += obj.offsetLeft + 'px';
                oPicBox1.style.top += obj.offsetTop + 'px';
                oPicBox1.style.backgroundImage = obj.style.backgroundImage;
